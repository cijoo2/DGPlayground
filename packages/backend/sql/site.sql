...
(
    GOD_ID VARCHAR2(5) NOT NULL,
	GOD_NAME NVARCHAR2(14) NOT NULL,
    GOD_IMG NVARCHAR2(256) NULL,
	GOD_DESC NVARCHAR2(512) NOT NULL,
    GOD_PRICE NUMBER(10) NOT NULL,
    GOD_DCRATE NUMBER(5) NOT NULL,
    
    CONSTRAINT T_GOODS_PK PRIMARY KEY (ID)  -- 
);

INSERT INTO T_GOODS VALUES
(
    'GOD00001', '요가 매트', '/workout/plank.png','',36250, 20
);
